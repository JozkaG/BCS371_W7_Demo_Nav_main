...
fun SecondScreen(navController: NavController) {
    ...
    var sliderSwitch by remember { mutableStateOf(true)}

    val context = LocalContext.current
    Column ( modifier = Modifier.padding(horizontal = 20.dp),
        verticalArrangement = Arrangement.Center,
        horizontalAlignment = Alignment.CenterHorizontally){
        Slider(value = sliderValue, onValueChange = { sliderValue=it }, Modifier.fillMaxWidth(), enabled = sliderSwitch)
        ...
        // ToDo 8: when the switch is off, disable the slider
            ...
            Checkbox(
                ...
                onCheckedChange = { sliderSwitch = it },
