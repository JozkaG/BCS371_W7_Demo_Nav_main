...
fun BasicOperations(name: String, modifier: Modifier = Modifier) {
    ...
    var checkbutton by remember { mutableStateOf(false) }
    ...
    Column {
        ...
        Button( onClick = {
            val newInt = Intent(Intent.ACTION_VIEW)
            // ToDo 1: create implicit intent to open a web page or call a phone number (done)
            newInt.setData(Uri.parse("https://www.google.com/"))
        ...
        Button( onClick = {
            // ToDo 2: create explicit intent to open a new activity (Any, Done)
        ...
        // ToDo 3: Change the spacing between the icons and text to be 10dp (TEXT? DONE)
        ...
        Switch(
            checked = checkbutton,
            onCheckedChange = { checkbutton = it },
            modifier = Modifier.padding(10.dp),
        )
        // ToDo 6: when the switch is off, disable the buttons (DONE AFTER BUTTON)
